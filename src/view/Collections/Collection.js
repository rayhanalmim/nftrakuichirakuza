...
const Collection = ({ number }) => {
  ...
  return (
    ...
    <div
      className="max-w-[1500px] flex w-full mx-auto  rounded-lg"
    ...
    >
              ...
              <div className=" border rounded-lg " style={{ padding: "10px" }}>
                {data?.getAllCollection
                  ?.slice(
                    0,
                    !isMobile
                      ? data?.getAllCollection?.length / 2 + 1
                      : data?.getAllCollection?.length
                  )
                  .reverse()
                  .map((data, index) => {
                    return (
      ...
      {!isMobile && (
        <div>
          {data?.getAllCollection?.length > 0 ? (
            <div
              className="max-w-[1500px] mx-auto pt-5 md:pt-[2rem] px-5"
              style={ovrflwhid}
            >
              <div className="flex flex-row-reverse justify-between pt-5  pb-5 gap-[20px] md:gap-[100px] md:px-2 px-2">
                <h4 className="text-grey  font-bold capitalize md:w-[100px]">
              ...
              <div className=" md:px-0 px-2">
                <div
                  ...
                  style={{ padding: "30px 15px", overflow: "hidden" }}
                >
                  {data?.getAllCollection
                    ?.slice(
                      data?.getAllCollection?.length / 2 + 1,
